...
<!--<link href="<%=path %>/js/icheck/skins/all.css" rel="stylesheet" type="text/css">-->
<!-- IconFont图标 -->
...
<!-- 航班信息 -->
  ...
  <h3 class="mar-bottom-20">航班信息 <span class="label label-primary font12 mar-left-10" style=" vertical-align:middle;"></span></h3>
  <div class="lh30 pad-10 bg-gray-f5">
    <ul class="list-inline ">
      <li class="w-percentage-20"><b class="font16">${flightTicket.flight.startcity }— ${flightTicket.flight.endcity }</b></li>
      <li class="w-percentage-15">${flightTicket.flight.aircompany }${flightTicket.flight.airname }</li>
      <li class="w-percentage-15">${flightTicket.airticket.seattype }</li>
      <li class="w-percentage-20"><b class="font16" id="startTime">${flightTicket.flight.starttime }</b> 起飞</li>
      <li class="w-percentage-20"><b class="font16" id="endTime">${flightTicket.flight.endtime }</b> 到达</li>
    </ul>
  </div>
...
<!-- 旅客信息 -->
  <h3 class="mar-bottom-20">订单信息 <small class="mar-left-20 font14">乘客人数：${fn:length(passengers) } 人</small></h3>
  <div class="lh30 ">
  	<c:forEach items="${passengers }" var="item">
  		<div class=" bor-bottom-solid-d8-1 bor-top-solid-1">
      <ul class="list-inline ">
        <li class="w-percentage-25">${item.type }：${item.name }</li>
        <li class="w-percentage-25">身份证：${item.idcard }</li>
      </ul>
      <ul class="list-inline ">
        <li class="w-percentage-25">结算价：
   		<c:choose>
   			<c:when test="${item.type=='成人' }">${flightTicket.airticket.price }</c:when>
   			<c:when test="${item.type=='儿童' }">${flightTicket.airticket.price*0.8 }</c:when>
   			<c:when test="${item.type=='婴儿' }">${flightTicket.airticket.price*0.5 }</c:when>
   		</c:choose>
   		     
        （票面价：${flightTicket.airticket.price }）</li>
    ...
    <div class=" pull-right mar-top-10" >支出金额：<span class="rmb orange-f60">￥</span><span class=" orange-f60 text-right font24">${totalPrice }</span></div>
 ...
 <div class="tab-content">
  <div class="tab-pane bank-block-list2" id="tab1">
   <ul id="bank-change" style=" width:90%; margin-left:auto; margin-right:auto;">
    <li><img src="<%=path %>/img/wallet/ico-bank/1.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/2.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/3.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/4.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/5.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/6.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/7.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/8.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/9.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/10.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/11.gif"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/16.gif"></li>
   </ul>
   <div class="clearfix"></div>
  ...
  <div class="tab-pane active bank-block-list2" id="tab2">
   ...
   <!--<li ><img src="<%=path %>/img/wallet/ico-bank/yucunkuan.jpg"></li>-->
    <li><img src="<%=path %>/img/wallet/ico-bank/zhifubao.jpg"></li>
    <li><img src="<%=path %>/img/wallet/ico-bank/caifutong.jpg"></li>
   </ul>
   <div class="clearfix"></div>
...
<form method="post" action="${pageContext.request.contextPath }/need/PayController">

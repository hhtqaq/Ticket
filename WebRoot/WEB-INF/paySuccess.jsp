...
<div class="container mar-top-10 mar-bottom-10">
  <div class="row ">
    <div class="col-md-5"> <img src="${pageContext.request.contextPath }/css/imgs/logo.png" width="210" height="70" alt="系统LOGO" class="pull-left mar-right-30">
...
<div class="tishibox">
  <p class="title">支付已成功!</p>
   <p>您可以继续操作：<a href="${pageContext.request.contextPath }/need/OrderController">[查看我的订单]</a> <a href="${pageContext.request.contextPath }/index.jsp">[返回首页]</a> </p>
  <div class="img_fudong"> <a href="#"><img src="<%=path %>/img/chenggong2.gif" width="50" height="50" border="0" /></a></div>
...
<div class="text-center mar-bottom-10">
  <input type="button" value="返回" class="btn btn-default " onclick="javascript: window.location.href='${pageContext.request.contextPath }/need/OrderController';" > 
</div>

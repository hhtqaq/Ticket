		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table2">
			<tr>
				...
				<table border="0" width="145" id="table7" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td width="150" height="35"><p align="right"><font color="#FFFFFF">欢迎您：${sessionScope.admin.username }<b></b></font></td>
					</tr>
				</table>
				</div>
				</td>
						...
						<div align="right">
							<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table5">
								<tr>
									...
									<td width="189"> <font color="#ffffff">今天是：<fmt:formatDate value="<%=new Date() %>" pattern="yyyy-MM-dd HH:mm:ss"/> </SCRIPT></font></td>
								</tr>
							</table>
						</div>
						</td>
						...
						<div align="right">
							<table border="0" width="215" cellspacing="0" cellpadding="0" id="table6" height="23">
								<tr>
									...
									<td width="55" valign="middle"><a href="${pageContext.request.contextPath}/login" target="_top"><font color="ffffff">重新登录</font></a></td>
								</tr>
							</table>
						</div>
						</td>
